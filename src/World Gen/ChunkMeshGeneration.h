...
private:
    ...
    static void AddEdgeFaces(glm::ivec3 localBlockPos, int &numFaces, int &numNonSolidFaces, int neighbourZ, int neighbourX, Chunk* tempChunk, Faces face, Chunk& chunk);
